...
/datum/perk/klutz
	name = "Klutz"
	desc = "You find a lot of tasks a little beyond your ability to perform such as using any type of weaponry, but being accident prone has at least made you used to getting hurt."
	icon_state = "klutz"
...
/datum/perk/codespeak/serbian/assign(mob/living/carbon/human/H)
	if(..())
		add_verb(holder, codespeak_procs)


/datum/perk/codespeak/serbian/remove()
	if(holder)
		remove_verb(holder, codespeak_procs)
	..()
...
/datum/perk/technomancy
	name = "Technomancy"
	desc = "You have been with the Artificers' Guild for years and know how to handle your electricals. You interact with electrical devices with far greater proficiency than other colonists."
	icon_state = "inspiration"
