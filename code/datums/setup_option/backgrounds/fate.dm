...
/datum/perk/greenthumb
	...
	//var/virtual_scanner = new /obj/item/device/scanner/plant/perk - commented out for porting purposes - REENABLE LATER SOMEHOW!
...
/datum/perk/noble/assign(mob/living/carbon/human/H)
	...
	var/picklist = list( //Total weight sum = 24
				...
				/obj/item/tool/knife/ritual = 5,
				/obj/item/tool/sword/saber = 6,
				/obj/item/tool/sword/katana = 6,
